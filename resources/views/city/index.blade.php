			...
			<div class="wrap-content wrap-right clearfix">
				...
				<div style="width:700px; height:400px; margin:0 auto; position:relative;">
					...
					<div style="z-index:102; position:absolute;top:0px;left:0px;">
						...
						<!--<area shape="poly" style="z-index:150;" alt="" title="" coords="615,380,577,353,599,324,645,316,672,339,691,367,659,376" href="{{url('/city/grotte')}}" onmouseover="show_light('6');" onmouseout="hide_light('6');">-->
